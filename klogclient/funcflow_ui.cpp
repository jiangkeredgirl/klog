...
void FuncFlowui::setupUi(QDialog* hostDialog)
{
	...
	if (m_hostDialog)
	{
		m_hostDialog->setWindowTitle(tr("函数调用流"));
...
void FuncFlowui::FuncStacksAddInTrees(const string& process_name, const string& threadid, list<string>& func_stacks)
{
	int process_row = 0;
...
void FuncFlowui::FuncStacksAddInTree(list<string>& func_stacks, QTreeWidget* thread_tree)
{
...
void FuncFlowui::AddItem(QTreeWidget* thread_tree, QTreeWidgetItem* parentItem, list<string>& func_stacks)
{
