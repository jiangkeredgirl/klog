...
#define TraceWaitAsyncEnd                            KKTracePackage::TracePrinter::instance()->WaitTraceThreadEnd()
#define TraceCreateStdout                            KKTracePackage::TracePrinter::instance()->CreateKlogConsole()
#define TraceSetStdoutUTF8                           KKTracePackage::TracePrinter::instance()->SetKlogConsoleUTF8()
#define TraceGenerateDump                            KKTracePackage::TracePrinter::instance()->GenerateDumpInfo()
